...
echo 51_invoicedata_1d.ini >> log.txt
Boss_s2c.exe 51_invoicedata_1d.ini
if errorlevel 1 echo 51_invoicedata_1d.ini >> error.txt

echo 51_orderdata_1d.ini >> log.txt
Boss_s2c.exe 51_orderdata_1d.ini
if errorlevel 1 echo 51_orderdata_1d.ini >> error.txt
