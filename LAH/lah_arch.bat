...
echo 51_invoicedata_arch.ini >> log.txt
Boss_s2c.exe 51_invoicedata_arch.ini
if errorlevel 1 echo 51_invoicedata_arch.ini >> error.txt

echo 51_orderdata_arch.ini >> log.txt
Boss_s2c.exe 51_orderdata_arch.ini
if errorlevel 1 echo 51_orderdata_arch.ini >> error.txt
